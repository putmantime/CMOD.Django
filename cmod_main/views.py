        ...
        if operon_data['authorized'][0] == 'True':  # check if user has authorized wikigenomes
            ...
            if operon_data['operonQID'][0] == 'None':  # if operon is not in wikidata create a new one
                ...
                try:
                    ...
                    print("existing qid", operon_data['operonQID'][0])
                    new_operon_wd_item = PBB_Core.WDItemEngine(wd_item_id=operon_data['operonQID'][0], domain=None, data=operon_statements)
